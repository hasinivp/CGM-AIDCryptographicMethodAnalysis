...
\subsection{Encryption Algorithms Evaluated} \label{key}
...
This modern AEAD encryption is very similar to AES-CCM, and differs only in the use of the authentication format.
...
\begin{table}[H]
    ...
    \begin{tabularx}{\linewidth}{|X|X|X|X|X|}
        ...
        \hline
        Transmission of Glucose Reading & Reading blocked from being transmitted & Tampered reading is accepted & Replayed reading & Controller flooded with readings-DDoS \\
        \hline
...
\textbf{Engineering Implications - Security Constraints}\\
...
\begin{itemize}
    \item SC-1: Integrity of messeges must be preserved - 
    \item SC-2:
    \item SC-3:
    \item SC-4:
\end{itemize}
